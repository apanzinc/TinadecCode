...
- `executor_git_manager` is the dedicated Git Manager Subagent. Bind read goals plus index, commit, checkout, and
  branch create/delete/rename tools to approval-gated TinadecTools descriptors; keep `git_worktree_manager` for push, remaining mutations,
