...
**Last Updated By:** Codex (Git conflict tools)
**Last Verified Commit:** 130d2b8
**Branch:** main
...
- `executor_git_manager` is the execution-layer Git Manager Subagent. It may explain branch/status/diff/worktree/push readiness; all Git mutations execute through approved TinadecTools calls, while `git_worktree_manager` remains only as a legacy compatibility adapter.
