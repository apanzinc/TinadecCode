...
**Last Updated By:** Codex (Git branch tools)
**Last Verified Commit:** 5b2998a
**Branch:** main
...
- `executor_git_manager` is the execution-layer Git Manager Subagent. It may explain branch/status/diff/worktree/push readiness; index, commit, checkout, and branch create/delete/rename execute through approved TinadecTools calls, while push and the remaining Git mutations stay approval-gated through `git_worktree_manager` until migrated.
